...
type Props = {
  ...
  setSelectDoctor: (doctor: doctorAgent) => void;
  selectedDoctor?: doctorAgent; // Make selectedDoctor optional
};

function SuggestedDoctorCard({ doctorAgent, setSelectDoctor, selectedDoctor }: Props) {
  return (
    <div
      className={`flex flex-col items-center border rounded-2xl shadow p-5 cursor-pointer hover:border-blue-800
